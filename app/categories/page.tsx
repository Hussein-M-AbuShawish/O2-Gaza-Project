...
const CONFIG = {
  ...
  deliveryLocations: {
    gaza: [
      ...
      { name: "النفق", price: 10 },
      { name: "التفاح", price: 10 },
      { name: "شارع يافا", price: 10 },
      { name: "الساحة", price: 10 },
      { name: "الصبرة", price: 10 },
      { name: "الزيتون", price: 10 },
      { name: "الصفطاوي", price: 10 },
      { name: "ابو اسكندر", price: 10 },
      { name: "الصاروخ", price: 10 },
      { name: "ارض الشنطي", price: 10 },
      { name: "صالة الحلو", price: 10 },
      { name: "المخابرات", price: 10 },
