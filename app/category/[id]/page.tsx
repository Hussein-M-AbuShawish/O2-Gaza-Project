...
const CONFIG = {
  ...
  deliveryLocations: {
    gaza: [
      ...
      { name: "الشاطئ الشمالي", price: 5 },
      { name: " الامن العام", price: 5 },
      { name: " الميناء", price: 5 },
      { name: "الشعبية", price: 5 },
      { name: "الدرج", price: 5 },
      { name: "دوار ال 17", price: 5 },
      { name: "الشاليهات", price: 5 },
      { name: "الشيخ رضوان الشارع الاول", price: 5 },
      { name: "الشيخ رضوان الشارع الثاني", price: 5 },
      { name: "الشيخ رضوان الشارع الثالث", price: 5 },
      { name: "الرمال الجنوبي", price: 5 },
      { name: "الكرامة", price: 5 },
      { name: "تل الهوا", price: 5 },
      { name: "تل الهوا، رمزون الازهر", price: 5 },
      { name: "دوار المالية", price: 5 },
      { name: "دوار ابو مازن", price: 5 },
      { name: "دوار حيدر", price: 5 },
      { name: "اليرموك", price: 5 },
      { name: "النفق", price: 5 },
      { name: "التفاح", price: 5 },
      { name: "شارع يافا", price: 5 },
      { name: "الساحة", price: 5 },
      { name: "الصبرة", price: 5 },
      { name: "الزيتون", price: 5 },
      { name: "الصفطاوي", price: 5 },
      { name: "ابو اسكندر", price: 5 },
      { name: "الصاروخ", price: 5 },
      { name: "ارض الشنطي", price: 5 },
      { name: "صالة الحلو", price: 5 },
      { name: "المخابرات", price: 5 },
      { name: "دوار ابو شرخ", price: 5 },
      { name: "الفالوجا", price: 5 },
